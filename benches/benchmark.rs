...
pub fn criterion_benchmark(c: &mut Criterion) {
    c.bench_function("Twine: str concat short", |b| b.iter(|| {
        let t1 = &Twine::from("foo");
        let t2 = &Twine::from("bar");
        let r = t1 + t2;
        let _ = black_box(r);
    }));
    c.bench_function("Twine: str concat short + to_string_preallocating", |b| b.iter(|| {
        let t1 = &Twine::from("foo");
        let t2 = &Twine::from("bar");
        let a = t1 + t2;
    ...
    c.bench_function("Twine: str concat short + to_string", |b| b.iter(|| {
        let t1 = &Twine::from("foo");
        let t2 = &Twine::from("bar");
        let a =  t1 + t2;
        let r = a.to_string();
    ...
    c.bench_function("String: str concat short", |b| b.iter(|| {
